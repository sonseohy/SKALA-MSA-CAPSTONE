...
## 4. 백엔드 수정이 필요할 수 있는 기능

MVP에서 새로 구현할 가능성이 있는 것은 **만족도 조사** 정도다.

권장 방향:

- 새 서비스를 만들지 않는다.
- `enrollment-service` 안에 Survey Entity/API를 작게 추가한다.
- 교육 결과 분석은 구현하지 않고 향후 개발 예정으로 설명한다.
