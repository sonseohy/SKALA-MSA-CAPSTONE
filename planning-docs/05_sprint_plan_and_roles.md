...
Sprint 2는 결제 흐름 표현, 만족도 조사, 결과 요약처럼 있으면 서비스 완성도가 올라가는 기능에 집중한다.
...
### 6번: 프론트 마이페이지/상태/QA 담당

주요 책임:

- Login, MyPage, EnrollmentView 변경
- 내 교육/계약 목록 상태 표시
- 만족도 조사 UI 후보
...
- 만족도 조사 기능 또는 설계 문서 완성
- 교육별 만족도 요약 화면 또는 API 명세 완성
- 최종 발표 흐름과 산출물 정리 완료
